...
INSERT INTO groups (name) values ('K3120');
INSERT INTO groups (name) values ('K3240');
INSERT INTO groups (name) values ('K3310');
INSERT INTO groups (name) values ('M4120');
INSERT INTO groups (name) values ('OpenMath');
INSERT INTO groups (name) values ('OpenProgramming');
...
INSERT INTO tests (title, type, subject_id, is_random, creator_id) values ('Wonderfull math', 'private', 1, TRUE, 2);
INSERT INTO tests (title, type, subject_id, is_random, creator_id) values ('Progaprogapro', 'public', 2, FALSE, 6);
INSERT INTO tests (title, type, subject_id, is_random, creator_id) values ('Physics for chainycs', 'private', 4, FALSE, 2);
INSERT INTO tests (title, type, subject_id, is_random, creator_id) values ('And math again', 'private', 1, TRUE, 6);
INSERT INTO tests (title, type, subject_id, is_random, creator_id) values ('SLOJNAAA', 'public', 3, TRUE, 2);

INSERT INTO questions (type, test_id, phrase, right_answer, structure) values ('radiobutton', 1, '2 + 2 is?', '4', '10, 6, 15, 4');
INSERT INTO questions (type, test_id, phrase, right_answer, structure) values ('checkbox', 1, 'x^2 = 4, x is?', '-2, 2', '8, -4, 2, 4, -2');
INSERT INTO questions (type, test_id, phrase, right_answer) values ('input', 1, '2^64 is', 'hren znaet');
INSERT INTO questions (type, test_id, phrase) values ('textfield', 5, 'Write me an essay');
INSERT INTO questions (type, test_id, phrase, right_answer, structure) values ('checkbox', 5, 'Translate of cat', 'кот', 'сервер, мышка, кот, паспорт');
INSERT INTO questions (type, test_id, phrase, right_answer) values ('input', 2, 'The best OS', 'Ubuntu');
INSERT INTO questions (type, test_id, phrase, right_answer) values ('input', 3, 'You anyway will not understand it, so just try to guess', 'resistance');
INSERT INTO questions (type, test_id, phrase, right_answer) values ('input', 3, '1/0', 'AAAAAAAAAA');
